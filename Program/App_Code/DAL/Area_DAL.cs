...
namespace ATOM.DAL
{
    ...
    public partial class Area
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(ATOM.Model.Area model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Area(");
            strSql.Append("ProvinceId,CityId,AreaName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(ATOM.Model.Area model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ATOM.Model.Area GetModel(int Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,ProvinceId,CityId,AreaName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime from Area ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            ATOM.Model.Area model = new ATOM.Model.Area();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ATOM.Model.Area DataRowToModel(DataRow row)
        {
            ATOM.Model.Area model = new ATOM.Model.Area();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,ProvinceId,CityId,AreaName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,ProvinceId,CityId,AreaName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime ");
            strSql.Append(" FROM Area ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
