...
namespace ATOM.DAL
{
    ...
    public partial class Department
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(ATOM.Model.Department model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Department(");
            strSql.Append("DepartmentName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(ATOM.Model.Department model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ATOM.Model.Department GetModel(int Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,DepartmentName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime from Department ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            ATOM.Model.Department model = new ATOM.Model.Department();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ATOM.Model.Department DataRowToModel(DataRow row)
        {
            ATOM.Model.Department model = new ATOM.Model.Department();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,DepartmentName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,DepartmentName,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime ");
            strSql.Append(" FROM Department ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
