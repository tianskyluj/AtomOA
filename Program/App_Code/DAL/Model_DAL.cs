...
namespace ATOM.DAL
{
    ...
    public partial class Module
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(ATOM.Model.Module model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Module(");
            strSql.Append("ModuleName,Url,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime)");
            strSql.Append(" values (");
            strSql.Append("@ModuleName,@Url,@state,@remark,@createUser,@createIp,@createTime,@updateUser,@updateIp,@updateTime)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@ModuleName", SqlDbType.NVarChar,200),
					new SqlParameter("@Url", SqlDbType.Int,4),
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(ATOM.Model.Module model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ATOM.Model.Module GetModel(int Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,ModuleName,Url,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime from Module ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            ATOM.Model.Module model = new ATOM.Model.Module();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ATOM.Model.Module DataRowToModel(DataRow row)
        {
            ATOM.Model.Module model = new ATOM.Model.Module();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,ModuleName,Url,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,ModuleName,Url,state,remark,createUser,createIp,createTime,updateUser,updateIp,updateTime ");
            strSql.Append(" FROM Module ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
