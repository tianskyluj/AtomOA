...
public class inc
{
    ...
    //在Ajax 中使用弹出框 
    public static void msg(UpdatePanel e, string str)
    {
        ScriptManager.RegisterClientScriptBlock(e, ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "alert('" + str + "');", true);
    }
    //在Ajax 中执行Script语句 
    public static void ExecuteScript(UpdatePanel e, string str)
    {
        ScriptManager.RegisterClientScriptBlock(e, ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "" + str + "", true);
    }
    //在Ajax 中执行Script语句，显示操作成功
    public static void pagemsg(UpdatePanel e, string str)
    {
        ScriptManager.RegisterClientScriptBlock(e, ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "showsuccess('" + str + "');", true);
    }
    //在Ajax 中弹出警告框和页面转向(警告消息，页面名)
    public static void msgandgotopage(UpdatePanel e, string _message, string _pagename)
    {
        ScriptManager.RegisterStartupScript(e, ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "alert('" + _message + "');window.location.href='" + _pagename + "';", true);
    }
    ...
    public static void showSuccessMsg(UpdatePanel e, string message)
    {
        ScriptManager.RegisterClientScriptBlock(e, ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "noty({\"text\":\"" + message + "\",\"theme\":\"noty_theme_default\",\"layout\":\"topCenter\",\"type\":\"success\",\"textAlign\":\"center\",\"easing\":\"swing\",\"animateOpen\":{\"height\":\"toggle\"},\"animateClose\":{\"height\":\"toggle\"},\"speed\":500,\"timeout\":2500,\"closable\":false,\"closeOnSelfClick\":true,\"closeOnSelfOver\":true});", true);
    }
    public static void showSuccessMsg(string message)
    {
        ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).ClientScript.RegisterStartupScript(((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "noty({\"text\":\"" + message + "\",\"theme\":\"noty_theme_default\",\"layout\":\"topCenter\",\"type\":\"success\",\"textAlign\":\"center\",\"easing\":\"swing\",\"animateOpen\":{\"height\":\"toggle\"},\"animateClose\":{\"height\":\"toggle\"},\"speed\":500,\"timeout\":2500,\"closable\":false,\"closeOnSelfClick\":true,\"closeOnSelfOver\":true});", true);

    }

    public static void showErrorMsg(UpdatePanel e, string message)
    {
        ScriptManager.RegisterClientScriptBlock(e, ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "noty({\"text\":\"" + message + "\",\"theme\":\"noty_theme_default\",\"layout\":\"topCenter\",\"type\":\"error\",\"textAlign\":\"center\",\"easing\":\"swing\",\"animateOpen\":{\"height\":\"toggle\"},\"animateClose\":{\"height\":\"toggle\"},\"speed\":500,\"timeout\":2500,\"closable\":false,\"closeOnSelfClick\":true,\"closeOnSelfOver\":true});", true);
    }
    public static void showErrorMsg(string message)
    {
        ((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).ClientScript.RegisterStartupScript(((System.Web.UI.Page)System.Web.HttpContext.Current.Handler).GetType(), "script", "noty({\"text\":\"" + message + "\",\"theme\":\"noty_theme_default\",\"layout\":\"topCenter\",\"type\":\"error\",\"textAlign\":\"center\",\"easing\":\"swing\",\"animateOpen\":{\"height\":\"toggle\"},\"animateClose\":{\"height\":\"toggle\"},\"speed\":500,\"timeout\":2500,\"closable\":false,\"closeOnSelfClick\":true,\"closeOnSelfOver\":true});", true);
