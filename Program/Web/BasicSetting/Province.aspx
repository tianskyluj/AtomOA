<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Province.aspx.cs" Inherits="Web_BasicSetting_Province" %>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-hover table-condensed well">
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="provinceName_search" runat="server"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:CheckBox ID="provinceName_check_search" runat="server" Checked="false" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
...
<script src="../PostJS/BasicSetting_Province.js"></script>
</html>
