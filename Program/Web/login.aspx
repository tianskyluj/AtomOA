...
<body>
    <div class="container">
        ...
        <div class="row-fluid">
            ...
            <asp:Button runat="server" ID="login" Text="登 录"
                CssClass="btn btn-primary pull-right span6" onclick="login_Click" />
            <asp:Label ID="fafa" runat="server"></asp:Label>
        </div>
        </form>
        <div class="form-footer-copyright">
            2013 © <small>原子OA管理系统</small>
        </div>
    </div>
